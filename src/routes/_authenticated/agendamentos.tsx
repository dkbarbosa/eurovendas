  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        <KPICard icon={CalendarDays} label="Total no período" value={fmtNum(totals.total)} />
        <KPICard icon={Clock} label="Hoje" value={fmtNum(totals.hoje)} />
        <KPICard icon={CalendarDays} label="Esta semana" value={fmtNum(totals.semana)} />
        <KPICard icon={TrendingUp} label="Futuros" value={fmtNum(totals.futuros)} />
        <KPICard icon={Users} label="House" value={fmtNum(totals.house)} />
        <KPICard icon={Users} label="Parceiros" value={fmtNum(totals.imob)} />
      </div>
